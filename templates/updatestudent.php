<!-- Modal -->
<div id="updatestudentModal" class="modal" role="dialog" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true" >
  ...
  <h4 class="modal-title">UPDATE STUDENT INFO</h4>
        ...
        <button type="button" id="updatestudentupdis" class="close" data-dismiss="modal">&times;</button>
 ...
 <button type="submit" name="submit" class="btn btn-success">Submit</button>
      ...
      <div class="modal-footer">
        ...
        <button type="button" id="updatestudentdowndis" class="btn btn-secondary" data-dismiss="modal">Close</button>
